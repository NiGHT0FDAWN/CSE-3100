//In this assignment, we write code to solve the closest-pair problem.
//Given n (n > 1) points on a plane (a 2 dimentional surface), 
//find the closest pair of points, i.e., the pair of points
//that has the shortest distance inbetween.
